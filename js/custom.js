...
(function($){
	...
	app.header = {
		...
		superfish: function(){
			$('#primary-menu > div > ul, .top-links > ul').superfish({
				popUpSelector: 'ul,.big-menu-content,.top-link-section',
				delay: 250,
				speed: 350,
...
// Below is the javascript plugin I used to facilitate menu dropdown
